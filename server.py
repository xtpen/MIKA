...
=======
>>>>>>> e2b82635369e400914955fd7e86e2d94e8f71b51
...
<<<<<<< HEAD
    ...
    (["cough", "coughing"], "Stay hydrated, use cough drops or lozenges, try over-the-counter cough medicines, and consider using a humidifier to moisten the air.", None),
    (["nasal congestion", "nasal", "congestion"], "Use saline nasal sprays or rinses, try over-the-counter decongestants, use a humidifier, and consider taking a hot shower to help relieve congestion.", None),
    (["sore throat", "throat", "sore", "hoarseness", "hoarse"], "Gargle with warm salt water, drink warm liquids such as tea with honey, use throat lozenges or sprays, and consider over-the-counter pain relievers like acetaminophen or ibuprofen.", None),
    (["runny nose", "runny", "drippy"], "Use over-the-counter antihistamines or decongestants, try saline nasal sprays, stay hydrated, and consider using a humidifier.", None),
    (["sneezing", "sneeze", "sneezy"], "Avoid triggers if possible (such as allergens), use over-the-counter antihistamines, and consider nasal corticosteroid sprays.", None),
    (["headache", "ache", "head", "migraine", "head ache"], "Rest in a quiet, dark room, apply a cold compress to the forehead, try over-the-counter pain relievers like acetaminophen or ibuprofen, and stay hydrated.", "z-img/saridon.png"),
    (["fatigue", "tired", "unrest"], "Get plenty of rest, maintain a regular sleep schedule, engage in light physical activity, eat a balanced diet, and stay hydrated.", None),
    (["fever", "high temp", "high temperature", "feverish", "hot"], "Drink plenty of fluids, rest, dress lightly, use over-the-counter fever reducers like saridon or ibuprofen, and seek medical attention if the fever persists or is high.", None),
    (["body pain", "pain", "ache", "body ache"], "Apply heat or cold packs to the affected area, rest, use over-the-counter pain relievers like acetaminophen or ibuprofen, and consider gentle stretching exercises.", None),
    ...
    (["dizzy", "dizziness", "collapse", "fall"], "Sit or lie down, stay hydrated, avoid sudden movements, and consider deep breathing exercises or relaxation techniques.", None),
    (["shortness of breath", "shortness", "breath"], "Sit upright, practice breathing exercises, use a fan or open windows for fresh air, and seek medical attention if the shortness of breath is severe or persistent.", None),
    (["chest pain", "chest", "pain"], "Seek immediate medical attention, especially if the chest pain is severe, prolonged, or accompanied by other symptoms such as difficulty breathing or pain radiating to the arm or jaw.", None),
    ...
    (["nausea", "vomiting", "vomit", "puke", "puking"], "Stay hydrated with clear fluids, eat small, bland meals, avoid strong odors or foods that trigger nausea, and consider over-the-counter anti-nausea medications.", None),
    ...
    (["dehydration", "dry skin", "dry mouth", "dry lip", "chapped lip"], "Drink plenty of fluids, especially water, to stay hydrated. Use moisturizers for dry skin and lip balm for dry lips. Avoid caffeine and alcohol, as they can contribute to dehydration.", None),
    (["stiff neck", "stiff", "neck"], "Apply heat or cold packs to the affected area. Practice gentle neck stretches and exercises. Maintain good posture and avoid activities that strain the neck muscles.", None),
    (["hunger", "extreme hunger"], "Eat regular, balanced meals and snacks throughout the day to maintain stable blood sugar levels. Include protein, fiber, and healthy fats in your meals to promote satiety. Avoid skipping meals, as it can lead to excessive hunger and overeating later.", None),
    (["numbness", "tingling", "sensation"], "Rest the affected limb or area. Massage the area gently to improve blood circulation. Avoid activities that exacerbate the numbness or tingling.", None),
    ...
    (["irritation", "irritability"], "Practice stress management techniques such as deep breathing, meditation, or yoga. Communicate openly about your feelings and needs with loved ones or a therapist. Ensure you're getting enough quality sleep to help regulate mood.", None),
    ...
    (["slurred speech", "slurred", "slur", "speech"], "Speak slowly and clearly, practice tongue and speech exercises recommended by a speech therapist, avoid alcohol and sedating medications that may exacerbate slurred speech, seek medical attention if slurring is sudden or accompanied by other neurological symptoms.", None),
    (["back pain", "back", "pain", "aching", "ache"], "Maintain good posture, use ergonomic furniture and support cushions, apply heat or cold packs to the affected area, perform gentle stretching exercises and low-impact activities like walking or swimming, consider physical therapy or chiropractic care for long-term management.", None),
    (["leg pain", "leg", "pain", "aching", "ache"], "Elevate legs and apply cold compresses to reduce swelling and inflammation, perform gentle stretching exercises, wear supportive footwear, avoid prolonged standing or sitting, consult a healthcare professional for evaluation and treatment of underlying causes.", None),
    (["shoulder pain", "shoulder", "pain", "aching", "ache"], "Rest the affected shoulder and avoid activities that worsen pain, apply ice packs to reduce inflammation, perform gentle shoulder exercises to improve range of motion and strength, consider physical therapy or corticosteroid injections for persistent pain.", None),
    (["muscle pain", "muscle", "pain", "aching", "ache"], "Rest the affected muscles and avoid overexertion, apply heat or cold therapy to reduce pain and inflammation, gently massage the area to promote relaxation, take over-the-counter pain relievers like ibuprofen or acetaminophen, consider physical therapy or acupuncture for chronic muscle pain.", None),
    (["neck pain", "neck", "pain", "aching", "ache"], "Practice good posture and avoid activities that strain the neck, apply heat or cold packs to the affected area, perform gentle neck stretches and exercises, use a supportive pillow and mattress, consider massage therapy or chiropractic care for relief.", None),
    (["foot pain", "feet pain", "foot", "feet", "pain", "aching", "ache"], "Wear supportive, well-fitted shoes with cushioned insoles, rest and elevate the affected foot, apply ice packs to reduce swelling and inflammation, perform gentle foot stretches and exercises, consider orthotic inserts or custom-made shoes for chronic foot pain.", None),
    (["hand pain", "hands pain", "hand", "hands", "pain", "aching", "ache"], "Rest the affected hand and avoid repetitive movements, apply ice packs to reduce swelling and inflammation, perform gentle hand exercises and stretches, use supportive splints or braces, consider hand therapy or corticosteroid injections for persistent pain.", None),
=======
